...
LAB19:    if (*((unsigned int *)t24) < *((unsigned int *)t23))
        goto LAB18;
...
LAB31:    if (*((unsigned int *)t42) > *((unsigned int *)t41))
        goto LAB30;

LAB29:    *((unsigned int *)t43) = 1;

LAB30:    memset(t47, 0, 8);
    t48 = (t43 + 4);
...
LAB50:    if (*((unsigned int *)t101) < *((unsigned int *)t100))
        goto LAB49;
...
LAB71:    if (*((unsigned int *)t165) != 0)
        goto LAB72;

LAB73:    t173 = *((unsigned int *)t87);
...
LAB62:    if (*((unsigned int *)t119) > *((unsigned int *)t118))
        goto LAB61;

LAB60:    *((unsigned int *)t120) = 1;

LAB61:    memset(t124, 0, 8);
    t125 = (t120 + 4);
...
LAB81:    t220 = *((unsigned int *)t208);
    t221 = *((unsigned int *)t214);
    *((unsigned int *)t208) = (t220 | t221);
    t222 = (t11 + 4);
    t223 = (t200 + 4);
    t224 = *((unsigned int *)t11);
    t225 = (~(t224));
...
extern void work_m_00000000002319854764_3291741626_init()
{
	static char *pe[] = {(void *)Cont_28_0};
	xsi_register_didat("work_m_00000000002319854764_3291741626", "isim/CPU_TestBench_isim_beh.exe.sim/work/m_00000000002319854764_3291741626.didat");
