...
#endif
static const char *ng0 = "F:/Course/CO/P6_new/CPU/ByteEnExtend.v";
...
LAB38:    t316 = (t0 + 3720);
    ...
    *((unsigned int *)t326) = (t328 | t322);
    xsi_driver_vfirst_trans(t316, 3, 3);
    t329 = (t0 + 3592);
    *((int *)t329) = 1;
...
LAB38:    t324 = (t0 + 3784);
    ...
    *((unsigned int *)t334) = (t336 | t330);
    xsi_driver_vfirst_trans(t324, 2, 2);
    t337 = (t0 + 3608);
    *((int *)t337) = 1;
...
LAB58:    memcpy(t256, t218, 8);

LAB59:    memset(t288, 0, 8);
    t289 = (t256 + 4);
...
LAB72:    if (*((unsigned int *)t289) != 0)
        goto LAB73;

LAB74:    t297 = *((unsigned int *)t133);
...
LAB42:    t332 = (t0 + 3848);
    ...
    *((unsigned int *)t342) = (t344 | t338);
    xsi_driver_vfirst_trans(t332, 1, 1);
    t345 = (t0 + 3624);
    *((int *)t345) = 1;
...
LAB48:    memcpy(t202, t164, 8);

LAB49:    memset(t234, 0, 8);
    t235 = (t202 + 4);
...
LAB66:    memcpy(t264, t234, 8);

LAB67:    memset(t296, 0, 8);
    t297 = (t264 + 4);
...
LAB76:    if (*((unsigned int *)t297) != 0)
        goto LAB77;

LAB78:    t305 = *((unsigned int *)t141);
...
LAB69:    if (*((unsigned int *)t257) != 0)
        goto LAB70;

LAB71:    t265 = *((unsigned int *)t234);
...
LAB42:    t340 = (t0 + 3912);
    ...
    *((unsigned int *)t350) = (t352 | t346);
    xsi_driver_vfirst_trans(t340, 0, 0);
    t353 = (t0 + 3640);
    *((int *)t353) = 1;
...
LAB66:    memcpy(t272, t234, 8);

LAB67:    memset(t304, 0, 8);
    t305 = (t272 + 4);
...
extern void work_m_00000000001178551686_2185821977_init()
{
	static char *pe[] = {(void *)Cont_28_0,(void *)Cont_29_1,(void *)Cont_30_2,(void *)Cont_31_3};
	xsi_register_didat("work_m_00000000001178551686_2185821977", "isim/CPU_TestBench_isim_beh.exe.sim/work/m_00000000001178551686_2185821977.didat");
