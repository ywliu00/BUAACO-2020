...
#endif
static const char *ng0 = "F:/Course/CO/P5/CPU/InstrDecoder.v";
...
static unsigned int ng25[] = {0U, 0U, 0U, 0U};
...
LAB34:    t671 = (t0 + 3968);
    ...
    t674 = (t673 + 56U);
    t675 = *((char **)t674);
    xsi_vlog_bit_copy(t675, 0, t3, 0, 60);
    xsi_driver_vfirst_trans(t671, 0, 59);
    t676 = (t0 + 3696);
    *((int *)t676) = 1;
